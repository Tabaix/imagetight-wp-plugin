 ...
 */
class TSP_ImageTight
{
    private static $instance = null;

    // Shared option keys (same as standalone plugin for compatibility)
    const OPT_API_KEY   = 'itc_api_key';
    const OPT_QUALITY   = 'itc_compression_quality';
    const OPT_FORMAT    = 'itc_output_format';
    ...
    private function __construct()
    {
        ...
        add_action('wp_ajax_tsp_itc_scan',         [$this, 'ajax_scan']);
        add_action('wp_ajax_tsp_itc_compress',      [$this, 'ajax_compress']);
        add_action('wp_ajax_tsp_itc_restore',       [$this, 'ajax_restore']);
        add_action('wp_ajax_tsp_itc_save_settings', [$this, 'ajax_save_settings']);
        add_action('wp_ajax_tsp_itc_quota',         [$this, 'ajax_quota']);
    ...
    public function auto_compress_on_upload($metadata, $attachment_id)
    {
        ...
        $_REQUEST['nonce'] = wp_create_nonce('uam_admin_nonce');
