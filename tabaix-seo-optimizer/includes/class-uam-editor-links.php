...
class UAM_Editor_Links
{
    ...
    public function enqueue_editor_assets($hook)
    {
        ...
        wp_enqueue_style('uam-editor-links', UAM_PLUGIN_URL . 'assets/css/editor-links.css', [], UAM_VERSION);
        wp_enqueue_script('uam-editor-links', UAM_PLUGIN_URL . 'assets/js/editor-links.js', ['jquery'], UAM_VERSION, true);
        wp_localize_script('uam-editor-links', 'uamEditorLinks', [
    ...
    public static function handle_analyze_draft()
    {
        ...
        $result = UAM_API::generate($prompt);
