...
class UAM_Admin
{
    ...
    public function register_menus()
    {
        ...
        add_submenu_page('uam-dashboard', 'Dashboard', 'Dashboard', 'edit_posts', 'uam-dashboard', [$this, 'page_dashboard']);
        add_submenu_page('uam-dashboard', 'Content Generator', 'Content Generator', 'edit_posts', 'uam-content', [$this, 'page_content']);
        add_submenu_page('uam-dashboard', 'SEO & Optimizer', 'SEO & Optimizer', 'edit_posts', 'uam-seo', [$this, 'page_seo']);
        add_submenu_page('uam-dashboard', 'Image AI', 'Image AI', 'edit_posts', 'uam-images', [$this, 'page_images']);
        add_submenu_page('uam-dashboard', 'Comment Moderator', 'Comment Moderator', 'moderate_comments', 'uam-moderation', [$this, 'page_moderation']);
        add_submenu_page('uam-dashboard', 'Analytics & Reports', 'Analytics & Reports', 'edit_posts', 'uam-analytics', [$this, 'page_analytics']);

        add_submenu_page('uam-dashboard', 'Internal Links', 'Internal Links', 'edit_posts', 'uam-internal-links', [$this, 'page_internal_links']);
        add_submenu_page('uam-dashboard', 'Settings', 'Settings', 'manage_options', 'uam-settings', [$this, 'page_settings']);
    }
    ...
    public function enqueue_assets($hook)
    {
        ...
        wp_localize_script('uam-admin', 'uamAdmin', [
            ...
            'provider' => UAM_Settings::get('provider', 'gemini'),
            'pluginUrl' => UAM_PLUGIN_URL,
            'chatbotEnabled' => (int) UAM_Settings::get('chatbot_enabled', 0),
            'currentPage' => sanitize_text_field($_GET['page'] ?? 'uam-dashboard'),
        ]);
    }
    ...
    {
        $provider = UAM_Settings::get('provider', 'gemini');
        $has_gemini = !empty(UAM_Settings::get('gemini_api_key'));
        $has_openai = !empty(UAM_Settings::get('openai_api_key'));
        ?>
        <div class="uam-wrap">
            <?php $this->render_header(); ?>
            <div class="uam-dashboard-grid">
                <!-- Status Card -->
                <div class="uam-card uam-status-card">
                    ...
                    <div class="uam-status-list">
                        ...
                        <div class="uam-status-item <?php echo UAM_Settings::get('moderation_auto') ? 'ok' : 'off'; ?>">
                            <span class="uam-status-dot"></span>
                            <span>Auto Moderation
                                <?php echo UAM_Settings::get('moderation_auto') ? 'Active' : 'Disabled'; ?>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="uam-card">
                    ...
                    <div class="uam-quick-actions">
                        <a href="<?php echo esc_url(admin_url('admin.php?page=uam-content')); ?>" class="uam-action-btn">
                        ...
                        <a href="<?php echo esc_url(admin_url('admin.php?page=uam-images')); ?>" class="uam-action-btn">
                            <span class="dashicons dashicons-format-image"></span> Generate Image
                        </a>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=uam-analytics')); ?>" class="uam-action-btn">
                ...
                <div class="uam-card uam-features-card">
                    ...
                    <div class="uam-features-list">
                        <?php
                        $features = [
                            ['icon' => 'dashicons-edit', 'label' => 'Blog Post Drafts', 'page' => 'uam-content'],
                            ['icon' => 'dashicons-cart', 'label' => 'Product Descriptions', 'page' => 'uam-content'],
                            ['icon' => 'dashicons-search', 'label' => 'SEO & Meta Generation', 'page' => 'uam-seo'],
                            ['icon' => 'dashicons-share', 'label' => 'Social Media Posts', 'page' => 'uam-content'],
                            ['icon' => 'dashicons-email-alt', 'label' => 'Email Marketing Copy', 'page' => 'uam-content'],
                            ['icon' => 'dashicons-format-image', 'label' => 'AI Image Generation', 'page' => 'uam-images'],
                            ['icon' => 'dashicons-visibility', 'label' => 'Readability Analysis', 'page' => 'uam-seo'],
                            ['icon' => 'dashicons-shield', 'label' => 'Comment Moderation', 'page' => 'uam-moderation'],

                            ['icon' => 'dashicons-admin-links', 'label' => 'Internal Links', 'page' => 'uam-internal-links'],
                            ['icon' => 'dashicons-analytics', 'label' => 'Analytics &amp; Reports', 'page' => 'uam-analytics'],
                        ];
            ...
            <div class="uam-tab-pane" id="tab-il-autolink">
                <div class="uam-two-col">
                    <div class="uam-panel">
                        ...
                        <div class="uam-field-group uam-toggle-group">
                            <label class="uam-toggle-switch">
                                <input type="checkbox" id="il-autolink-enabled" <?php checked(UAM_Settings::get('autolink_enabled'), 1); ?>>
                                <span class="uam-toggle-slider"></span>
                            </label>
    ...
    public function page_settings()
    {
        if (isset($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'], 'uam_settings_nonce')) {
            ...
            $settings['gemini_model'] = sanitize_text_field($_POST['gemini_model'] ?? UAM_API::DEFAULT_GEMINI_MODEL);
            $settings['openai_model'] = sanitize_text_field($_POST['openai_model'] ?? UAM_API::DEFAULT_OPENAI_MODEL);
            ...
            update_option(UAM_Settings::OPTION_KEY, $settings);
        ...
        $gmodel = $s['gemini_model'] ?? UAM_API::DEFAULT_GEMINI_MODEL;
        $omodel = $s['openai_model'] ?? UAM_API::DEFAULT_OPENAI_MODEL;
        ?>
        <div class="uam-wrap">
            <?php $this->render_header(); ?>
            <form method="post" class="uam-settings-form">
                <?php wp_nonce_field('uam_settings_nonce'); ?>
                    ...
                    <div class="uam-card">
                        ...
                        <div class="uam-field-group">
                            ...
                            <select name="gemini_model" id="gemini_model" class="uam-select">
                                <?php foreach (UAM_API::gemini_models() as $v => $l): ?>
                    ...
                    <div class="uam-card">
                        ...
                        <div class="uam-field-group">
                            ...
                            <select name="openai_model" id="openai_model" class="uam-select">
                                <?php foreach (UAM_API::openai_models() as $v => $l): ?>
    ...
    {
        $provider = UAM_Settings::get('provider', 'gemini');
        $chatbot_enabled = (int) UAM_Settings::get('chatbot_enabled', 0);
        ?>
