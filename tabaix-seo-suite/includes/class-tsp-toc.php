...
class TSP_TOC
{
    ...
    public function enqueue_assets()
    {
        ...
        wp_enqueue_style('tsp-toc-style', plugins_url('../assets/css/tsp-toc.css', __FILE__), [], '1.0.0');
        wp_enqueue_script('tsp-toc-script', plugins_url('../assets/js/tsp-toc.js', __FILE__), [], '1.0.0', true);
    }
